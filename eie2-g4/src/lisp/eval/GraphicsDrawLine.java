...
/**
 * draw-lineの組み込み手続き Canvasから呼ばれる Canvas上に線分を描画
 * 
 * @author sam0830
 * @version 1.0
 */
public class GraphicsDrawLine implements Subroutine {
	private static final GraphicsDrawLine drawLine = new GraphicsDrawLine();
	 ...
	 */
	public static GraphicsDrawLine getInstance() {
		return drawLine;
	}
