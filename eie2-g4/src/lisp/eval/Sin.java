...
public class Sin implements Subroutine {
	...
	public SExpression apply(SExpression sexp, Environment environment) throws LispException {
		...
		float number = (car instanceof Int) ? ((Int) car).getValue() : ((lisp.eval.Flo) car).getValue();
		return lisp.eval.Flo.valueOf((float) Math.sin(number));
